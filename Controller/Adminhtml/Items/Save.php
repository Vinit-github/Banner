...
class Save extends \Xlab\Banner\Controller\Adminhtml\Items
{
        ...
        if ($this->getRequest()->getPostValue()) {
            try {
                ...
                if ($this->getRequest()->getParam('back')) {
                    $this->_redirect('xlab_banner/*/edit', ['id' => $model->getId()]);
                    return;
                }
                ...
                if (!empty($id)) {
                    $this->_redirect('xlab_banner/*/edit', ['id' => $id]);
                } else {
                    $this->_redirect('xlab_banner/*/new');
                }
                return;
            } catch (\Exception $e) {
